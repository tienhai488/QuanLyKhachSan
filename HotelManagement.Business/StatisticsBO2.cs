namespace HotelManagement.Data.Access
{
    ...
    public class StatisticsBO2
    {
        ...
        private readonly List<(int, double)> revenueByMonth = new List<(int, double)> { };
        private readonly List<(string, double)> roomRevenueByType = new List<(string, double)> { };
        private readonly List<(string, double)> serviceRevenueByType = new List<(string, double)> { };
